    ...
    fun render(taskCategory: TaskCategory, onItemSelected: (Int) -> Unit) {
        ...
        when (taskCategory) {
            TaskCategory.Business -> {
                tvCategoryName.text = ContextCompat.getString(
                    viewContainer.context,
                    R.string.todo_dialog_category_business
                )
            ...
            TaskCategory.Other -> {
                tvCategoryName.text = ContextCompat.getString(
                    viewContainer.context,
                    R.string.todo_dialog_category_other
                )
                divider.setBackgroundColor(
            ...
            TaskCategory.Personal -> {
                tvCategoryName.text = ContextCompat.getString(
                    viewContainer.context,
                    R.string.todo_dialog_category_personal
                )
                divider.setBackgroundColor(
